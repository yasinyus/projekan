                    ...
                    <div class="mb-5 fv-row" data-kt-password-meter="true">
                        <div class="mb-5">
                            ...
                            <div class="position-relative mb-3">
                                <input class="form-control form-control-lg form-control" type="password" placeholder="Masukan Password Anda" id="password" name="password" required autocomplete="off" />
                            </div>
                    </div>
                    <div class="fv-row mb-5">
...
<?php echo $__env->make('layout.template-login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/dev/front-end/resources/views/login/login-jarjastel.blade.php ENDPATH**/ ?>