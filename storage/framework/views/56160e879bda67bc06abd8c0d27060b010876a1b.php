...
<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
    ...
    <div class="card w-lg-500px">
        <div class="card-header text-center" style="background-color: #600A88 !important;">
            <div class="card-title fs-3 fw-bolder text-light text-center">LOGIN TELEKOMUNIKASI KHUSUS BADAN HUKUM</div>
        </div>
        <div class="card-body p-9">
                <form class="form w-100" id="kt_sign_in_form" action="registrasi-telsusbh-person/" method="post">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <a href="registrasi-telsusbh" class="link-primary fw-bolder">Daftar</a></div>
                    </div>
                </form>
        </div>
    </div>
...
<?php echo $__env->make('layout.template-login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/dev/front-end/resources/views/login/login-telsusbh.blade.php ENDPATH**/ ?>