<div class="modal fade" id="kt_modal_sumary" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                            ...
                            <div class="d-flex flex-row flex-column-fluid">
                                <div class="d-flex flex-row-fluid flex-center">
                                    <div class="flex-grow-1 text-center pt-15">
                                        <h1>KONFIRMASI KODE IZIN BARU (OSS RBA)</h1>
                                        <h3 id="jenisPenyelenggaraanSummary"></h3>
                                        <h3 id="mediaTransmisiSummary"></h3>
                                        <h3>KODE IZIN BARU : <span id="kodeIzinBaruSummary"></span></h3>
                                        <br>
                                        <h1> PERIZINAN BERUSAHA:</h1>
                                        <h3>NAMA PERUSAHAAN : <span id="namaPerusahaanSummary"></span></h3>
                                        <h3>NOMOR INDUK BERUSAHA : <span id="nibSummary"></span></h3>
                                        <h3>KBLI : <span id="kbliSummary"></span></h3>
                                        <h3>TANGGAL PENGAJUAN : <span id="tanggalPengajuanSummary"></span></h3>
                                        <br><br>
