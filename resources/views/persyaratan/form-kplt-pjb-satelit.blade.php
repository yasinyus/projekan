<div class="card card-flush me-5 mb-10">
        <div class="card-body pt-5 px-20">
            ...
            <h5 class="mb-10">Penyelenggaraan Jaringan Bergerak Satelit</h5>
            <table class="table table-row-bordered form-table">
            <thead>
                <tr class="fw-bolder fs-6 text-center text-gray-800">
                    <th>Periode</th>
                    <th>Kapasitas Transponder Satelit yang disewakan (MHz / Mbps) </th>							
                    <th>Kapasitas Sistem (SSM)</th>
                    <th class="text-end">Aksi</th>
                </tr>
            </thead>
            
            <tbody id="body-kplt-pjb-satelit">
                <tr>
        ...
        <div class="d-flex flex-stack pt-10">
            <!--begin::Wrapper-->
            <div class="me-2">
                <button type="button" id="tambah-kplt-pjb-satelit" class="btn btn-outline btn-outline-primary">
                    TAMBAH DATA
                </button>
            </div>
            <!--end::Wrapper-->							
            <!--begin::Wrapper-->
            <div>
                <button type="button" id="simpan-kplt-pjb-satelit" class="btn btn-outline btn-outline-success">
                    SIMPAN DATA
                </button>									                
            </div>
            <!--end::Wrapper-->
...
@once
    @push('scripts')                    
    <script src="{{asset('theme')}}/js/kominfo/persyaratan/form-kplt-pjb-satelit.js" type="text/javascript"></script>        
    @endpush
@endonce
