<!--begin::Formulir Komitmen Pembangunan 5 Tahun Microwave Link-->
	<div class="card card-flush me-5 mb-10">
		<div class="card-body pt-5 px-20">
			<h3>Formulir Komitmen Pembangunan 5 Tahun</h3>
			<h5 class="mb-10">Penyelenggaraan Jaringan Tetap Tertutup - Microwave Link</h5>
			<table class="table table-row-bordered form-table">
			<thead>
				<tr class="fw-bolder fs-6 text-center text-gray-800">
					<th>Periode</th>
					<th>Minimal Jumlah Hop (Unit)</th>
					<th>Minimal Kapasitas Bandwidth (Mbps)</th>
					<th class="text-end">Aksi</th>
				</tr>
			</thead>
			
			<tbody id="body-kplt-jartup-microwave">
				<tr>
		...
		<div class="d-flex flex-stack pt-10">
			<!--begin::Wrapper-->
			<div class="me-2">
				<button type="button" id="tambah-kplt-jartup-microwave" class="btn btn-outline btn-outline-primary">
					TAMBAH DATA
				</button>
			</div>
			<!--end::Wrapper-->							
			<!--begin::Wrapper-->
			<div>
				<button type="button" id="simpan-kplt-jartup-microwave" class="btn btn-outline btn-outline-success">
					SIMPAN DATA
				</button>									                
			</div>
			<!--end::Wrapper-->
...
<!--end::Formulir Komitmen Pembangunan 5 Tahun  Microwave Link-->

@once
    @push('scripts')        
    <script src="{{asset('theme')}}/js/kominfo/persyaratan/form-kplt-jartup-microwave.js" type="text/javascript"></script>    
    @endpush
@endonce