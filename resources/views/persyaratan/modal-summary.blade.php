                            ...
                            <div class="d-flex flex-column-auto h-150px flex-center">	
                                <div class="d-flex flex-center">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">		                                
                                        <img alt="KOMINFO" th:src="@{/assets/media/kominfo/logo_kominfo.png}" class="h-100px" />	                                    	                               
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Text-->
                            ...
                            <div class="d-flex flex-row flex-column-fluid">
                                <div class="d-flex flex-row-fluid flex-center">
                                    <div class="flex-grow-1 text-center pt-15">
                                        ...
                                        <h3><span th:text="${applicationInfo.jenisPerizinan}"></span></h3>
                                        <h3><span th:text="${applicationInfo.mediaTransmisi}"></span></h3>
                                        <h3>NOMOR : <span th:text="${applicationInfo.nomorKIB}"></span></h3>
                                        <br>
                                        <h1> PERIZINAN BERUSAHA:</h1>
                                        <h3>NAMA PERUSAHAAN : <span th:text="${applicationInfo.namaPerusahaan}"></span></h3>
                                        <h3>NOMOR INDUK BERUSAHA : <span th:text="${applicationInfo.nomorNIB}"></span></h3>
                                        <h3>KBLI : <span th:text="${applicationInfo.kbli}"></span></h3>
                                        <h3>TANGGAL PENGAJUAN : <span th:value="${#dates.format(applicationInfo.tanggalPengajuan, 'dd-MM-yyyy')}"></span></h3>
                                        <br><br>
                                        <p>Penyampaian dokumen Pemenuhan Persyaratan telah berhasil.<br>Hasil evaluasi akan disampaikan paling lambat 5 hari kerja.</p>
                                    </div>
                                    <br><br>							            				                					                
                                </div>
                            </div>
