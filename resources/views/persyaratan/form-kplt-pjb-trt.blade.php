<div class="card card-flush me-5 mb-10">
        <div class="card-body pt-5 px-20">
            ...
            <h5 class="mb-10">Penyelenggaraan Jaringan Bergerak Terestrial Radio Trunking</h5>
            <table class="table table-row-bordered form-table">
            <thead>
                <tr class="fw-bolder fs-6 text-center text-gray-800">
                    <th>Periode</th>
                    <th>Jumlah Kanal (Unit)</th>							
                    <th>Kapasitas Pelanggan yang dilayani</th>
                    <th class="text-end">Aksi</th>
                </tr>
            </thead>
            
            <tbody id="body-kplt-pjb-trt">
                <tr>
                    <td><input type="text" name="periode[]" class="form-control" placeholder="xxx"/></td>				            				            
                    <td><input type="text" name="jumlah-kanal[]" class="form-control" placeholder="xxx"/></td>
        ...
        <div class="d-flex flex-stack pt-10">
            <!--begin::Wrapper-->
            <div class="me-2">
                <button type="button" id="tambah-kplt-pjb-trt" class="btn btn-outline btn-outline-primary">
                    TAMBAH DATA
                </button>
            </div>
            <!--end::Wrapper-->							
            <!--begin::Wrapper-->
            <div>
                <button type="button" id="simpan-kplt-pjb-trt" class="btn btn-outline btn-outline-success">
                    SIMPAN DATA
                </button>									                
            </div>
            <!--end::Wrapper-->
...
@once
    @push('scripts')                    
    <script src="{{asset('theme')}}/js/kominfo/persyaratan/form-kplt-pjb-trt.js" type="text/javascript"></script>    
    @endpush
@endonce
