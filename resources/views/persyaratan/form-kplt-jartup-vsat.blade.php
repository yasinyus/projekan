...
<div class="card card-flush me-5 mb-10">
        ...
        <div class="d-flex flex-stack pt-10">
            <!--begin::Wrapper-->
            <div class="me-2">
                <button type="button" id="tambah-kplt-jartup-vsat" class="btn btn-outline btn-outline-primary">
                    TAMBAH DATA
                </button>
            </div>
            <!--end::Wrapper-->							
            <!--begin::Wrapper-->
            <div>
                <button type="button" id="simpan-kplt-jartup-vsat" class="btn btn-outline btn-outline-success">
                    SIMPAN DATA
                </button>									                
            </div>
            <!--end::Wrapper-->
...
<!--end::Formulir Komitmen Pembangunan 5 Tahun  VSAT-->

@once
    @push('scripts')        
    <script src="{{asset('theme')}}/js/kominfo/persyaratan/form-kplt-jartup-vsat.js" type="text/javascript"></script>    
    @endpush
@endonce