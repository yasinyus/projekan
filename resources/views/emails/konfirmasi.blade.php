                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em;padding-bottom: 2em;">
                                    <div class="text">
                                        <h4>KONFIRMASI PENGAJUAN PEMENUHAN PERSYARATAN</h4>
                                        <p style="color:#3A3A3A;">Anda telah berhasil melakukan pendaftaran pada
                                            <b>“Portal Perizinan Telekomunikasi DITJENPPI” tanggal {{ date('Y-m-d H:i:s') }}</b>
                                        </p>
                                        <p>Terima kasih dokumen pemenuhan persyaratan telah diproses , Silahkan cek informasi dan status permohonan anda pada portal layanan izin.</p>
                                        <center>
                                        </center>
                                    </div>
                                </td>
