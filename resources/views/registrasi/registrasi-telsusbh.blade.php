...
<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
    ...
    <div class="card w-lg-500px">
        ...
        <div class="card-body p-9">
            <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" action="registrasi-telsusbh-person/" method="post">
                {{-- <div class="bg-purple"> --}}
                    <div class="mb-5 text-center w-100">
                        <div class="text-gray-400 fw-bold fs-4">Sudah punya akun?
                            <a href="login-telsusbh" class="link-primary fw-bolder">Masuk</a></div>
                    </div>
                {{-- </div> --}}
