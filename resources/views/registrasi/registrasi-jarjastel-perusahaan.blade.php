    ...
    <form id="kt_project_settings_form" class="form" action="{{ url('proses-perusahaan') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body p-9">
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-lg form-contro @error('npwp') is-invalid @enderror" type="file" id="npwp" name="npwp" autocomplete="off" accept="application/pdf"/>
                @error('npwp')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
